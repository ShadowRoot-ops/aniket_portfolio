...
const Navbar = () => {
  ...
  return (
    <div className="h-full flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-xl">
      ...
      {/* SOCIAL LINKS USING FLOATING DOCK */}
      <div className="hidden md:flex gap-4 w-1/3">
      ...
      <div className="md:hidden">
        ...
        {open && (
          <motion.div
            ...
            initial="closed"
            animate="opened"
            className="absolute top-0 left-0 w-screen h-screen bg-customblack text-customred flex flex-col items-center justify-center gap-8 font-bold text-[2rem] z-40"
          >
            {links.map((link) => (
